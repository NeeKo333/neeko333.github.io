...
!(function (e, t) {
  ...
  (E.event = {
    ...
    E.each(
      {
        mouseenter: "mouseo-sectionver",
        mouseleave: "mouseo-sectionut",
  ...
  (E.param = function (e, t) {
    ...
    E.each(
      "blur focus focusin focusout resize scroll click dblclick mousedown mouseup mousemove mouseo-sectionver mouseo-sectionut mouseenter mouseleave change select submit keydown keypress keyup contextmenu".split(
        " "
      ),
      function (e, n) {
        E.fn[n] = function (e, t) {
